...
class ContractDataBool extends Component {
  ...
  render() {
    ...
    var displayData = this.props.contracts[this.props.contract][this.props.method][this.dataKey].value ? "Yes" : "No";
...
export default drizzleConnect(ContractDataBool, mapStateToProps)