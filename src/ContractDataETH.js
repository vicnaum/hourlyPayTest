...
class ContractDataETH extends Component {
  ...
  render() {
    ...
    var displayData = web3.utils.fromWei(this.props.contracts[this.props.contract][this.props.method][this.dataKey].value);
...
export default drizzleConnect(ContractDataETH, mapStateToProps)